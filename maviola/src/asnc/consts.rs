...
pub(crate) const CONN_BROADCAST_CHAN_CAPACITY: usize = 1024;

pub(crate) const PEER_CONN_STOP_POOLING_INTERVAL: Duration = Duration::from_micros(100);
pub(crate) const PEER_CONN_STOP_JOIN_POOLING_INTERVAL: Duration = Duration::from_millis(100);
pub(crate) const PEER_CONN_STOP_JOIN_ATTEMPTS: usize = 30;
