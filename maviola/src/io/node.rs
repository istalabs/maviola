...
pub trait NodeInterface {
    ...
    /// latter case, message will be encoded according to MAVLink protocol version defined by for a node.
...
impl NodeInfo {
    ...
    ///
    /// Blocking to acquire mutex. You should never rely on exact value returned by
    /// this method.
